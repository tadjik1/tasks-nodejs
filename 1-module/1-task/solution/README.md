...
Понимание того, как выполняется тот или иной код - чрезвычайно важное качество, отличающее действительно хороших
разработчиков.
...
а в очередь микрозадач - асинхронные операции, выполнение коллбеков которых произойдет уже в рамках текущей операции.
...
```js
tasks = ['James', 'John']
microtasks = [] // <--- pull 'William' from here
```
